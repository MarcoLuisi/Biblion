...
/**
 * Servlet implementation class DisplayLibri
 */
@WebServlet("/DisplayLibri")
public class DisplayLibri extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Libro> prodotti = prodotto.getAllProdotto();
