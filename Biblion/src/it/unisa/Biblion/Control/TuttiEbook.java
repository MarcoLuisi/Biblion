...
/**
 * Servlet implementation class TuttiEbook
 */
@WebServlet("/TuttiEbook")
public class TuttiEbook extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Libro> prodotti = prodotto.getAllProdottoEbook();
