...
/**
 * Servlet implementation class LibriSpecifici1
 */
@WebServlet("/LibriSpecifici1")
public class LibriSpecifici1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LibriSpecifici1() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Libro> prodotti = prodotto.getProdottiSpecifici1(val);
