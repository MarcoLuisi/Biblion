...
<body style="background: url(Css/img_css/LRbackgroung1.jpg);">
		...
		<div class="loginbox">
			...
			<%Boolean logged = (Boolean) session.getAttribute("isWrongAbbonato1"); 
			if(logged != null){
			...
			<form action="LoginAbbonamento1" method="post">
				...
				<a href="registrazioneAbbonamento1.jsp"> Non hai un account ? Registrati ora...</a>
			</form>
		</div>
